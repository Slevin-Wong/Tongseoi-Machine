...
#### D3. 极端尺度
**绝对禁止：**
- ❌ 微观尺度：cells, molecules, atoms（细胞/分子/原子）
- ❌ 宇宙尺度：galaxies, nebulae, black holes（星系/星云/黑洞）
- ❌ "咖啡杯里的星云"等纯超现实概念——物理上不可能存在于现实世界的尺度错置

**原因**：人类感知尺度之外，违反写实原则，无法产生可信的视觉锚点

**⚠️ 引擎E豁免（重要）：**
以下尺度操纵手段**不在此禁令范围内**，属于引擎E策略4的合法创意路径：
- ✅ 将日常物件放大为地形/景观尺度（如：指甲刷的鬃毛阵列 = 稻田；汤勺弧面 = 水滑梯）
- ✅ 人物被置于放大的日常物件构成的微缩世界中（人物"变小"居住于其中）

**豁免判断标准（同时满足才豁免）：**
1. 物件本身仍可被识别为日常物件（不是抽象符号）
2. 放大后的视觉属性与景观的对应是直接的、无需文字解释的
3. 整体世界观在视觉上美观/壮观，不令人不安
